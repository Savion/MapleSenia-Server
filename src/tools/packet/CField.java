...
public class CField {
    ...
    public static byte[] getPublicNPCInfo() {
        ...
        final String[] publicNpcs = {"#cUniversal NPC#", "Move to #cMonster Park# to team up to defeat monsters.", "Move to a variety of #cparty quests#.", "Move to the #cFree Market# to trade items with players.", "Move to #cArdentmill#, the crafting town.","View the #cgame options# for MapleSenia", "Check #cdrops# of any monster in the map.", "Join an #cevent# in progress."};
